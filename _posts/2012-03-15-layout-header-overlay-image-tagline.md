...
permalink: /newsfeed/
---
<img src="{{ site.url }}{{ site.baseurl }}/Users/mac/Documents/GitHub/Vuthy/images/pp-collage.jpg" alt="linearly separable data">
<figure>
...
<img src="{{ site.url }}{{ site.baseurl }}/Users/mac/Documents/GitHub/Vuthy/images/pp-growth.gif" alt="linearly separable data">
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
